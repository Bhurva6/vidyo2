# Frontend Internship Assignment for Vidyo.ai
...
Evaluation: Assess the application's functionality, UI, and features through the deployed Vercel(https://vidyoplayer-nine.vercel.app/) link.
